...
#define DECLARE_DOWN_IF_N_SECONDS_WITHOUT_DATA 150 // allow two uploads (including the first retry) to fail, plus 20 seconds for each upload (min is 60, max is 255)
